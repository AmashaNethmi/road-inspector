...
export default function AnalyticsPage() {
  ...
  return (
    <motion.div className={styles.page} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <section className={styles.systemOverview} style={{
        ...
        <h2 style={{ fontSize: '1.2rem', marginBottom: '1rem', color: 'var(--text-primary)' }}>System Overview</h2>
        <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
          Welcome to the System Analytics dashboard. This module provides a comprehensive 
          overview of road infrastructure health, tracking reported defects, severity levels, 
          and repair material estimations over time. Use the metrics and charts below to 
          analyze inspection trends and prioritize maintenance schedules effectively.
        </p>
      </section>
